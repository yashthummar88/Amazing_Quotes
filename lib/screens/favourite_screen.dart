...
class _FavouriteScreenState extends State<FavouriteScreen> {
  ...
  @override
  void initState() {
    fetchQuotes = dbh.getFavouriteData();
        ...
        builder: (context, AsyncSnapshot snapQuotes) {
          ...
          return FutureBuilder(
              ...
              builder: (context, AsyncSnapshot snapImages) {
                ...
                return (snapQuotes.data.length == 0)
                    ? Center(
                        child: Text(
                          "Your Favourite List Empty.....",
                          style: TextStyle(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                            onPressed: () async {
                                              int res1 = 0;
                                              int res2 = 1;
                                              int favourite = snapQuotes
                                                  .data[index].addFavourite;
                                              if (favourite == 0) {
